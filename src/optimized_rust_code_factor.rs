pub fn bf_main<R: std::io::Read, W: std::io::Write>(mut reader: R, mut writer: W) {
    ...
    while mem[ptr] != 0 {
        ...
        while mem[ptr] != 0 {
            mem[ptr + 10] += mem[ptr].wrapping_mul(1);
            mem[ptr] = 0;
            ptr = ptr.wrapping_sub(10);
        }
        ...
        while mem[ptr] != 0 {
            ...
            while mem[ptr] != 0 {
                ...
                while mem[ptr] != 0 {
                    ...
                    mem[ptr + 2] += mem[ptr].wrapping_mul(1);
                    mem[ptr] = 0;
                    ptr = ptr.wrapping_sub(16);
                }
                ptr = ptr.wrapping_add(10);
                ...
                while mem[ptr] != 0 {
                    ptr = ptr.wrapping_add(3);
                    mem[ptr + 6] += mem[ptr].wrapping_mul(1);
                    mem[ptr] = 0;
            ...
            ptr = ptr.wrapping_add(7);
            mem[ptr - 11] += mem[ptr].wrapping_mul(1);
            mem[ptr] = 0;
            ptr = ptr.wrapping_add(3);
            while mem[ptr] != 0 {
                ptr = ptr.wrapping_add(7);
                                    ...
                                    while mem[ptr] != 0 {
                                        ...
                                        while mem[ptr] != 0 {
                                            ...
                                            while mem[ptr] != 0 {
                                                ...
                                                mem[ptr] = mem[ptr].wrapping_add(1);
                                                ptr = ptr.wrapping_add(3);
                                                mem[ptr - 8] += mem[ptr].wrapping_mul(1);
                                                mem[ptr] = 0;
                                            }
                                        }
                                    }
            ...
            ptr = ptr.wrapping_add(8);
            mem[ptr - 13] += mem[ptr].wrapping_mul(1);
            mem[ptr] = 0;
            ptr = ptr.wrapping_add(2);
            while mem[ptr] != 0 {
                ptr = ptr.wrapping_add(8);
